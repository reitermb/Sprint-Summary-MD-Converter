...
* [Background](<README (1).md#background>)
* [What we did & who we talked to](<README (1).md#what-we-did-and-who-we-talked-to>)
* [What we learned](<README (1).md#what-we-learned>)
* [Next steps](<README (1).md#next-steps>)
...
[^6]: Yun also requested re-ordering of the filters, starting with STT at the top.&#x20;

[^7]: 

[^8]: P2.&#x20;

[^9]: this is better than relative date. may want to mention somewhere that 3077 and 3076 are related and 3076 is the lower lift solution.&#x20;
